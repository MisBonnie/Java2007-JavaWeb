        ...
        <div class="col-md-5">
            <div style="width:440px;border:1px solid #E7E7E7;padding:20px 0 20px 30px;border-radius:5px;margin-top:60px;background:#fff;">
                ...
                <form action="${pageContext.request.contextPath}/LoginServlet" class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        <label for="inputrePassword3" class="col-sm-2 control-label">验证码</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="inputrePassword3" placeholder="请输入验证码">
                        </div>
                        <div class="col-sm-3">
...
<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
    Copyright &copy; 2017-2018 指针商城 版权所有
</div>
</body></html>